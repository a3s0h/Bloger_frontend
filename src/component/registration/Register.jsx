...
const Register = () => {
  ...
  return (
    <div className="text-center p-10">
      ...
      <h1 className="font-bold text-gray-700 text-5xl mb-3">Sign Up</h1>
            ...
            <div className="md:w-8/12 lg:ms-6 lg:w-5/12">
              <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <span>
                  Already a user?
                  <Link to="/login" className="text-primary focus:outline-none dark:text-primary-400 hover:text-orange-600"> Sign in</Link>
                  </span>
                </div>
                {/* Submit button */}
                <button 
